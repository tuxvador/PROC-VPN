...
VPN only the network traffic of the APP goes throught the VPN. 
...
to launch the script : sudo ./proc-vpn.sh terminator (with terminator being the process i want to run with its network segragated from the rest of the system)
